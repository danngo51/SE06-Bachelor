...
# Define folder paths
input_folder = "/Volumes/SSD/SEBachelor/entso-e data/ActualTotalLoad/"  
output_folder = "/Volumes/SSD/SEBachelor/entso-e data/Preproccessed/Results/ActualTotalLoad/"  
yearly_output_folder = "/Volumes/SSD/SEBachelor/entso-e data/Preproccessed/Results/ActualTotalLoad/Yearly/"
full_output_file = "/Volumes/SSD/SEBachelor/entso-e data/Preproccessed/Results/ActualTotalLoad/ActualTotalLoad_FullDataset_2019_2023.csv"
...
for filename in sorted(os.listdir(input_folder)):
    if filename.endswith(".csv"):
        ...
        df_clean["lag_1h"] = df_clean.groupby("MapCode")["TotalLoadValue"].shift(3)
        df_clean["lag_24h"] = df_clean.groupby("MapCode")["TotalLoadValue"].shift(72)
        df_clean["lag_168h"] = df_clean.groupby("MapCode")["TotalLoadValue"].shift(504)
...
for year, dfs in yearly_data.items():
    ...
    yearly_file_path = os.path.join(yearly_output_folder, f"ActualTotalLoad{year}.csv")
